<template>
  <div>
    <v-col sm="12 " md="4" offset-md="4" class="box">
      <v-col md="12">
        <v-card class="col mt-8" style="opacity: 0.9; border-radius: 20px" elevation="10"><v-card>
            <v-img src="../assets/logo.png" alt="Logo amusement park." style="
                  opacity: 3;
          ...
          <v-form ref="loginForm">
            <v-container>
              ...
              <v-text-field v-model="password" :append-icon="showPassword ? 'mdi-eye' : 'mdi-eye-off'"
                ...
                ]" name="input-10-1" label="Password*" hint="At least 8 characters" :counter="25"
                @click:append="showPassword = !showPassword"></v-text-field>

              <v-btn class="mt-4 mr-2 px-5 formButton" elevation="10" block dark rounded @click="login">
                Login
              </v-btn>
              <v-col class="row" cols="12">
                <v-col md="7" xs="6" style="font-size: 13px" class="pr-0 pl-1 mr-0">Don’t have an account?</v-col>
                <v-btn text to="sign-up" xs="6" class="pa-0 mt-1" style="text-transform: none">
                  Sign up
                </v-btn>
              </v-col>
            </v-container>
