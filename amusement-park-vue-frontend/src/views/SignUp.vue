        ...
        <v-card class="col mt-8" style="opacity: 0.9; border-radius: 20px" elevation="10"><v-card>
          ...
          <v-form ref="signUpForm">
            <v-container>
              ...
              <v-text-field v-model="signUpData.password" :append-icon="passwordShow ? 'mdi-eye' : 'mdi-eye-off'"
                :rules="[
                  (v) =>
              ...
              <v-file-input accept="image/png, image/jpeg,image/bmp" label="Profile photo (size: 1:1)*"
                prepend-icon="mdi-camera" v-model="image" @change="showImg" truncate-length="30" required :rules="[
                  (v) =>
                    !v ||
                    v.size < 1000000 ||
              ...
              <v-col class="row pr-0">
                <v-col md="6">
                  <v-btn class="formButton" elevation="10" block dark rounded to="/">
                    Back
                  </v-btn>
                </v-col>
                <v-col md="6" class="pr-0">
                  <v-btn class="formButton" elevation="10" block dark rounded @click="signUp">
                    Sign up
                  </v-btn>
                </v-col>
              </v-col>
