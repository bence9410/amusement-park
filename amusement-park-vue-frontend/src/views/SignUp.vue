      ...
      <v-container>
        <v-form ref="signUpForm">
          ...
          <v-text-field v-model="signUpData.password" :append-icon="passwordShow ? 'mdi-eye' : 'mdi-eye-off'" :rules="[
            ...
            hint="Length must be beetwen 8-25 and must contain upper and lowercase character and number." :counter="25"
          ...
          <v-text-field v-model="signUpData.confirmPassword"
            ...
            hint="Must be equals with password, length must be beetwen 8-25 and must contain upper and lowercase character and number." :counter="25"
          ...
          <v-menu ref="signUpBirthdateMenu" v-model="signUpBirthdateMenu" :close-on-content-click="false"
            ...
            <v-date-picker ref="signUpBirthdatePicker" v-model="signUpData.dateOfBirth"
              :max="new Date().toISOString().substr(0, 10)" min="1900-01-01" @change="selectBirthdate"></v-date-picker>
          </v-menu>
